...
//   subsystems.ts   feature table (tier, master switch, texture slots, WGSL hook)
//   permutation.ts  variant + enabled static subsystems <-> canonical shader id
...
//   wgsl.ts         generated shader fragments (struct declarations, group-2 bindings, off-stubs)
...
// shader module factory in webGPU/core/shaders/create.ts; the pass stages in
// webGPU/renderer/passes/hgrp/.
