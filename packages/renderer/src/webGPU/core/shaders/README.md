...
`hgrp_emission`, `hgrp_vfx_special`, `hgrp_fur_extrude` + `hgrp_fur`, `hgrp_fur_dye`,
`hgrp_hair_line_pattern`, `hgrp_hair_spec_normal`, `hgrp_face_highlight`, `hgrp_eye_matcap`,
`hgrp_brow_cutout` — without
