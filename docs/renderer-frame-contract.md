...
once in `material/hgrp/`, which also derives the byte layout, binding numbers and the generated
WGSL fragments that PipelineManager, MaterialBinder and the shaders all consume);
